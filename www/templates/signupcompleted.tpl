...
<ul>
    <li>Head down to the next CASSA workshop or seminar to pay your dues to
    ...
    <li>Direct deposit your dues into CASSA's bank account (see
     <a href="/membership">https://www.cassa.org.au/membership</a> for details), and email
    ...
    <li>Send a money-order (not cash) to CASSA's snail-mail address,
     available at <a href="/contact">https://www.cassa.org.au/contact</a> and email
